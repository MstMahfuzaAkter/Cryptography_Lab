...
def generate_all_keys(key_binary):

    print("\n================================================")
    print("KEY SCHEDULE (K1 - K16)")
    print("================================================")
...
def run_des_round(round_no, L_prev, R_prev, Kn):

    print("\n================================================")
    print("              ROUND", round_no)
    print("================================================")

    show("L" + str(round_no - 1), L_prev)
    show("R" + str(round_no - 1), R_prev)
    show("K" + str(round_no), Kn)
...
def run_des_16_rounds():
    ...
    keys = generate_all_keys(key_binary)
    ...
    for round_no in range(1, 17):
        L, R = run_des_round(round_no, L, R, keys[round_no - 1])

    print("\n================================================")
    print("PRE-OUTPUT (R16 + L16)")
    print("================================================")
    pre_output = R + L
    show("Pre-Output", pre_output)

    print("\n================================================")
    print("FINAL PERMUTATION (IP^-1)")
    print("================================================")
    ciphertext_binary = permute(pre_output, FP)
    show("Ciphertext", ciphertext_binary)

    print("\n================================================")
    print("              COMPLETED - ALL 16 ROUNDS")
    print("================================================")
    print("Final Ciphertext HEX :", binary_to_hex(ciphertext_binary))
